...
class TwbBundleForm extends Form
{
     ...
     */
    public function __invoke(FormInterface $oForm = null, $sFormLayout = '')
    {
        if ($oForm) {
     ...
     * @return string
     */
    public function render(FormInterface $oForm, $sFormLayout = '')
    {
     ...
     * @return string
     */
    protected function renderElements(FormInterface $oForm, $sFormLayout = '')
    {
        // Store button groups
        $aButtonGroups = array();
     ...
     */
    protected function setFormClass(FormInterface $oForm, $sFormLayout = '')
    {
