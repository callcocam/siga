...
class MakeForm extends Form{
    ...
    * @var array
    ...
    public function renderElements($oForm, $sFormLayout){
        ...
        $this->fields["#btn-voltar#"]=$this->view->Html('a',"VOLTAR",['class'=>'btn btn-danger','href'=>$this->view->url("{$this->view->route}/default",['controller'=>$this->view->controller,'action'=>'index'])])->appendText($this->view->glyphicon('share-alt'));
