...
class FactoryFilter extends Options {
    public function __construct($data, ContainerInterface $container) {
        ...
        $this->setUses(array(
            ...
            sprintf('%s\Form\%sFilter',$parent,$arquivo)=> null
        ));
        ...
        $this->setBody(sprintf('return new %sFilter($container);',$arquivo));
        // gera os methods podemos erar mais de um repetindo o codigo
