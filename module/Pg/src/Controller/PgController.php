...
// Add an item for this payment request
        ...
        $uri->setQuery(array());
        $uri->setFragment('');
        $retorno = sprintf("%s%s", $this->getRequest()->getServer('HTTP_ORIGIN'), $this->url()->fromRoute('retorno'));
        // Set the url used by PagSeguro to redirect user after checkout process ends
        $this->paymentRequest->setRedirectUrl($this->containerInterface,$retorno);
        // Another way to set checkout parameters
        $notificationURL = sprintf("%s%s", $this->getRequest()->getServer('HTTP_ORIGIN'), $this->url()->fromRoute('notification'));
        $this->paymentRequest->setNotificationURL($this->containerInterface,$notificationURL);
