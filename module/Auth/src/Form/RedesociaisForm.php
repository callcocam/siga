    ...
    public function __construct(ContainerInterface $containerInterface, $name = 'Redesociais', array $options = array())
    {
        ...
        $this->add([
                ...
                'options' => [
                    ...
                    'value_options'      =>[''=>'--SELECIONE--','OpenID'=>'OpenID','Yahoo'=>'Yahoo','AOL'=>'AOL','Google'=>'Google','Facebook'=>'Facebook','Twitter'=>'Twitter','Live'=>'Live'
                        ,'LinkedIn'=>'LinkedIn','Foursquare'=>'Foursquare','Instagram'=>'Instagram','GitHub'=>'GitHub'],
                    //'disable_inarray_validator' => true,
        ...
        $this->add([
                ...
                'options' => [
                    ...
                    'value_options'      =>['1'=>'HABILITADO','0'=>'DESABILITADO'],
                    //'disable_inarray_validator' => true,
        ...
        $this->add([
                ...
                'options' => [
                    ...
                    'value_options'      =>['1'=>'INCLUIR O EMAIL','0'=>'NÃO INCLUIR O EMAIL'],
                    //'disable_inarray_validator' => true,
        ...
        $this->add([
                ...
                'options' => [
                    ...
                    'value_options'      =>['online'=>'Online','offline'=>"OffLine"],
                    //'disable_inarray_validator' => true,
